  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8 md:py-12">
       ...
       <p className="text-center text-gray-300 mb-8 md:mb-8 max-w-2xl mx-auto text-sm md:text-base"> 
        Each internet milestone on the timeline below contains its profit model and technological impact. We need both facts and stories to truly understand something, but I think it's important to separate the two. Feel free to contribute personal stories, opinions, interesting theories, ideas, etc. There are no rules in the comments, but don&apos;t be a dick.
       <br/>
       <br/>
       Love,
       <br/>
